...
: Retrieves object tracks from the video frames.
  - 

add_position_to_tracks

: Adds positions to the tracks.
  - 

interpolate_ball_positions

: Interpolates ball positions in the tracks.
  - 

draw_annotations

: Draws object tracks on the video frames.
...
: Adjusts track positions based on camera movement.
  - 

draw_camera_movement

: Draws camera movement annotations on the video frames.
...
: Transforms and adds positions to the tracks.
...
: Draws speed and distance annotations on the video frames.
...
: Assigns team colors to players.
  - 

get_player_team

: Determines the team of a player based on their position.
